...
/**
 * Heart/Love icon for pet care theme
 */
...
/**
 * Pet house/shelter icon
 */
export const PetHouseIcon: React.FC<IconProps> = ({ className = '', size = 24 }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
